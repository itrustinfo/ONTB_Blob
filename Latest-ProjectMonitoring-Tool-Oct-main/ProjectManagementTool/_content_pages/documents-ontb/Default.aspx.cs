...
namespace ProjectManager._content_pages.documents_ontb
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    btnaddDocs.Visible = false;
                    btnAddGeneralDoc.Visible = false;
                    btnaddsubmittalforcategory.Visible = false;
                    //
                    GrdGeneralDocumentStructure.Columns[1].Visible = false;
                    GrdGeneralDocumentStructure.Columns[2].Visible = false;
                    //
                    GrdGeneralDocuments.Columns[3].Visible = false;
                    GrdGeneralDocuments.Columns[4].Visible = false;
                    GrdGeneralDocuments.Columns[5].Visible = false;
        ...
        public void BindTreeview()
        {
           ...
           // BindActivities();
            BindTreeView_GeneralDocuments();
            TreeView3.Nodes[0].Selected = true;
            TreeView3_SelectedNodeChanged(TreeView3.Nodes[0], null);
        }
        ...
        protected void BtnSearchDocuments_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!string.IsNullOrEmpty(TxtSearchDocuments.Value))
                {
                    ...
                    {
                        retrieveNodes_Search(TreeView3.Nodes[i], TxtSearchDocuments.Value);
                    }
