...
namespace ProjectManagementTool._content_pages.issues
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        private void LinkView_Click(object sender, EventArgs e)
        {
            ...
            bytes = getdt.DownloadIssueDocument(new_link.CommandArgument, out filename);
            ...
            if (file.Exists)
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "showImgModal('" + filename + "');", true);
                }
                else if (Extension == ".pdf")
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "showPdfModal('" + filename + "');", true);
                }
            }
        }
